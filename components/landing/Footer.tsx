...
export function Footer() {
    ...
    return (
        <footer ref={sectionRef} className="bg-black/10 relative z-10">
            <div ref={contentRef} className="px-4 sm:px-6 md:px-8 lg:px-16 py-12 sm:py-16">
                <div className="mx-auto">
                    {/* Main Footer Content */}
                    <div className="flex flex-col lg:flex-row justify-between items-start gap-8 sm:gap-12 mb-8 sm:mb-12">
                        {/* Brand Section */}
                        <div className="flex-1 max-w-md">
                            <h3 className="text-xl sm:text-2xl font-bold text-white mb-3 sm:mb-4">ScaleX</h3>
                            <p className="text-gray-400 text-sm sm:text-base leading-relaxed mb-4 sm:mb-6">
                                Revolutionary DeFi platform combining Order Book DEX with Lending Protocol for ultimate capital efficiency.
                            </p>
                        ...
                        <div className="flex flex-col sm:flex-row gap-8 sm:gap-12 lg:gap-16">
                            ...
                            <div>
                                ...
                                <ul className="space-y-2 sm:space-y-3">
                                    <li><a href="#" className="text-gray-400 hover:text-white transition-colors text-sm sm:text-base">Lending Protocol</a></li>
                                    <li><a href="#" className="text-gray-400 hover:text-white transition-colors text-sm sm:text-base">Order Book DEX</a></li>
                                </ul>
                            </div>
                    ...
                    <div className="border-t border-white/10 pt-6 sm:pt-8 flex flex-col md:flex-row justify-between items-center">
                        <p className="text-gray-400 text-xs sm:text-sm mb-4 md:mb-0">
                            © 2025 ScaleX. All rights reserved.
                        </p>
                    </div>
                </div>
            </div>
